...
<div class="pull-right">
  <button 
    ...
    style="background-color: black; border: 1px solid red; color: white;">
    Add product
  </button>
</div>
...
// Check if $product is null before accessing 'id'
//$product_id = isset($product['id']) ? $product['id'] : null;

// Display the product ID or an appropriate message
//if ($product_id !== null) {
